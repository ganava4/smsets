...
#' \eqn{T^2} test, extended two-sample and m-sample Levene’s tests for
#' multivariate data, one-way MANOVA, van Valen’s test and Box’s M test. A
#' Penrose's distance calculator is also implemented.
#'
#' @references
